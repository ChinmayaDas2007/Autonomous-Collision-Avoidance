  ...
  const EMBEDDED_SCENARIO = [
    {
      ...
      "decision": {
        "status": "EXECUTE_BURN", "go_no_go": "GO", "target_asset": "DEB-7",
        "conjunction_type": "SPACECRAFT_VS_DEBRIS",
        "scores": {
          "self": { "asset_id": "SAT-A", "score": 0.777, "factors": { "cost_lifetime": 0.91, "cost_delta_v": 0.78, "cost_priority": 0.60, "cost_downtime": 0.85 } },
          "peer": null
        },
    ...
    },
    {
      ...
      "decision": {
        "status": "MONITOR_PEER_MANEUVER", "go_no_go": "NO_GO", "target_asset": "DEB-7",
        "conjunction_type": "SPACECRAFT_VS_DEBRIS",
        "scores": {
          "self": { "asset_id": "SAT-A", "score": 0.654, "factors": { "cost_lifetime": 0.91, "cost_delta_v": 0.78, "cost_priority": 0.60, "cost_downtime": 0.85 } },
          "peer": null
        },
        "weights": { "w_lifetime": 0.25, "w_delta_v": 0.30, "w_priority": 0.25, "w_downtime": 0.20 }
      },
    ...
    },
    {
      ...
      "decision": {
        "status": "NO_MANEUVER_REQUIRED", "go_no_go": "NO_GO", "target_asset": "DEB-7",
        "conjunction_type": "SPACECRAFT_VS_DEBRIS",
        "scores": {
          "self": { "asset_id": "SAT-A", "score": 0.412, "factors": { "cost_lifetime": 0.48, "cost_delta_v": 0.35, "cost_priority": 0.60, "cost_downtime": 0.42 } },
          "peer": null
        },
        "weights": { "w_lifetime": 0.25, "w_delta_v": 0.30, "w_priority": 0.25, "w_downtime": 0.20 }
      },
    ...
    },
    {
      ...
      "decision": {
        ...
        "conjunction_type": "SPACECRAFT_VS_DEBRIS",
        "scores": {
          "self": { "asset_id": "SAT-A", "score": 0.211, "factors": { "cost_lifetime": 0.22, "cost_delta_v": 0.18, "cost_priority": 0.30, "cost_downtime": 0.21 } },
          "peer": null
        },
        "weights": { "w_lifetime": 0.25, "w_delta_v": 0.30, "w_priority": 0.25, "w_downtime": 0.20 }
      },
